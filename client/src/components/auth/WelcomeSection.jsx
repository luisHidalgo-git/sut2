const WelcomeSection = ({ type, onTypeChange }) => {
    if (type === 'login') {
        return (
            <div className="w-1/2 bg-primary p-12 text-white flex flex-col justify-center items-center">
                ...
                <button
                    ...
                    className="border-2 border-white text-white px-8 py-2 rounded-full hover:bg-white hover:text-primary transition-colors"
                >
                    Registrarse
                </button>
            </div>
